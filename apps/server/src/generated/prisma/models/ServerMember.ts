...
export type ServerMemberWhereUniqueInput = Prisma.AtLeast<{
  userId_serverId?: Prisma.ServerMemberUserIdServerIdCompoundUniqueInput
  AND?: Prisma.ServerMemberWhereInput | Prisma.ServerMemberWhereInput[]
  OR?: Prisma.ServerMemberWhereInput[]
  NOT?: Prisma.ServerMemberWhereInput | Prisma.ServerMemberWhereInput[]
  userId?: Prisma.StringFilter<"ServerMember"> | string
...
export type ServerMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "serverId" | "role" | "joinedAt", ExtArgs["result"]["serverMember"]>
...
export interface ServerMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const serverMemberWithUserIdOnly = await prisma.serverMember.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ServerMembers and only return the `userId`
   * const serverMemberWithUserIdOnly = await prisma.serverMember.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ServerMembers and only return the `userId`
   * const serverMemberWithUserIdOnly = await prisma.serverMember.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
